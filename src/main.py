...
def main(page: ft.Page):
    ...
    user_name = ft.TextField(label="Enter your name please")
    ...
    def join_click(e):
            if not user_name.value:
                 ...
                 page.pubsub.send_all(Message(user=user_name, text=f"{user_name.value} has joined the chat.", message_type="login_message"))
                 page.update()
